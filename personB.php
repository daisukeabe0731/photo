...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    // 画像を取得
    $sql = 'SELECT * FROM album WHERE person_id = 2 ORDER BY album_id DESC';
...
<body>
    <h2>Bさん</h2>
    <img class="facefolder" src="photoB.png" alt="Bさん">
    <style>
        .facefolder {
            width: 120px;
        }
    ...
    <a href="list.php" class="btn btn--blue">画像アップロード</a>
    <a href="catalog.php" class="btn btn--blue">画像振り分け</a>
    <a href="personA.php" class="btn btn--blue">Aさんフォルダ</a>
    <a href="personB.php" class="btn btn--blue">Bさんフォルダ</a>
    <a href="personC.php" class="btn btn--blue">Cさんフォルダ</a>
